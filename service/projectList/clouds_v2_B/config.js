...
const options = {
    method: 'POST',
    uri: 'https://bm.finleancloud.com/fcplat/fc/login/login',
...
async function getStaticFileState() {
    ...
    var status = await page.open('https://bm.finleancloud.com/fc_plat/#/login');
    // 获取网页节点
...
module.exports.projectName = '纷领云2.0平台端';

...
const options = {
    method: 'POST',
    uri: 'https://be.finlean.com/employee/login',
    body: {"mblNo": "18190811203", "password": "8123d3819a1f35ebc54c17b5c30015d5"},
    headers: {
...
async function getStaticFileState() {
    ...
    var status = await page.open('https://be.finlean.com/emtool/#/');
    // 获取网页节点
...
module.exports.projectName = '纷领云1.0业务员端 ';
